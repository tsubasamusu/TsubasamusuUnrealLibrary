...
public:
	...
	static UTexture2D* GetCameraViewTexture(UObject* WorldContextObject, UCameraComponent* CameraComponent, int32 TextureWidth = 256, int32 TextureHeight = 256, bool bUseCameraFieldOfView = true);
};